...
async def get_site_analyses():
    """Load site analyses from JSON file generated by AI analysis."""
    data_file = Path("app/data/analyzed_sites.json")

    if not data_file.exists():
        raise HTTPException(
            status_code=404,
            detail="No analyzed sites found. Run 'python ai.py' to generate analysis data.",
        )
